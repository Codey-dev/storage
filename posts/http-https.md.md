`Hypertext transfer protocol` is a protocol used to exchange the information over the internet in the form of text. Now the data might be of the different type but typically the text is transffered for example, image is transfered as BLOB (binary).
